...
if (file_exists($filesDataFile)) {
    ...
    BRfatal("File metadata not found! " . "$itemPath/${id}_files.xml");
}
...
function logError(description,page,line) {
    if (typeof(archive_analytics) != 'undefined') {
        var values = {
            ...
            'line': line,
            'itemid': '<?php echo $id;?>',
            'subPrefix': '<?php echo $subPrefix;?>',
            'server': '<?php echo $server;?>',
            'bookPath': '<?php echo $subItemPath;?>'
        };
...
br.bookId   = '<?php echo $id;?>';
br.zip      = '<?php echo $imageStackFile;?>';
br.subPrefix = '<?php echo $subPrefix;?>';
br.server   = '<?php echo $server;?>';
br.bookTitle= '<?php echo preg_replace('/\n/', ' ', preg_replace("/\'/", "\\'", $metaData->title . ' - ' . $metaData->year));?>';
br.bookPath = '<?php echo $subItemPath;?>';
br.bookUrl  = '<?php echo "http://library.tamu.edu/yearbooks/";?>';
br.imageFormat = '<?php echo $imageFormat;?>';
br.archiveFormat = '<?php echo $archiveFormat;?>';
...
OLAuth.prototype.setCookie = function(value) {
    ...
    cookie    += '; path=/; domain=.library.tamu.edu;';
